  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? "bg-background/60 backdrop-blur-xl border-white/10 shadow-sm" : "bg-transparent"
      )}
    >
                  ...
                  {navLinks.map((link) => (
                    <SheetClose asChild key={link.href}>
                      <Link
                        href={link.href}
                        className={cn(
                          "text-lg font-medium p-2 rounded-md transition-colors hover:bg-white/5",
